...
My solutions to [Advent of Code](https://adventofcode.com/) 2025. This year - in Golang. Let's Go! 🎅

## Structure of solutions

Solution for each day is contained in a folder called, e.g. `day-01`. The folder contains
three subfolders:
